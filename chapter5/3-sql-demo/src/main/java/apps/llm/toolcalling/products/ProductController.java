...
private final SqlTools sqlTools;
    ...
    @PostMapping("/chat-with-sql")
    public ChatBotResponse chatWithSql(@RequestBody ChatBotRequest chatBotRequest) {
...
Get all the tables  and then find the fields and then execute sql
"""));
