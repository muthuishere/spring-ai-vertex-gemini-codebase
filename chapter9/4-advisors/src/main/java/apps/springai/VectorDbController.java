...
public class VectorDbController {
    ...
    final DocumentRowMapper documentRowMapper;
    ...
    @GetMapping("/api/vectordb/documentsExists")
    public boolean checkRowsExist() {
        String sql = "SELECT COUNT(*) FROM vector_store";
        int count = jdbcTemplate.queryForObject(sql, Integer.class);
        return count > 0;
    }

    @GetMapping("/api/vectordb/documents")
    public List<Document> findAllRows() {
