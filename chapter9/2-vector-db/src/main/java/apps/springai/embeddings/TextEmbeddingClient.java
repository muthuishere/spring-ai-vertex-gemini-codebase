...
@Component
@Slf4j
public class TextEmbeddingClient extends AbstractEmbeddingClient {
    ...
    public TextEmbeddingClient(AuthService authService) {
    ...
    VertexTextEmbeddingResponse getEmbeddingValueForInstruction(String instruction) {
        ...
        log.info("instruction"+ instruction + "API URL: " + apiUrl);
