...
public class UnstructuredController {
    ...
    public ChatBotResponse chatWithProductImage(@RequestBody ChatBotRequest chatBotRequest) {
        ...
        ClassPathResource classPathResource = new ClassPathResource("/coupons.png");
        byte[] data = classPathResource.getContentAsByteArray();
        Media media = new Media(MimeTypeUtils.IMAGE_PNG, classPathResource);
